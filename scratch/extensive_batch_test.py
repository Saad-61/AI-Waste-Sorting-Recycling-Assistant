...
def main():
    ...
    # Curate balanced images across batch_1 to batch_6 using meta_df
    ...
    print(f"Total test suite assembled: {len(all_tests)} images")
    ...
    out_file = r"scratch\extensive_evaluation_results.json"
    os.makedirs(os.path.dirname(out_file), exist_ok=True)
    with open(out_file, "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nSaved {len(results)} extensive evaluations to {out_file}")
